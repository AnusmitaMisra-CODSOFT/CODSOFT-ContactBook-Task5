...
#---------------------------------------------
l_name = Label(Inside_Frame1,text="First Name")
...
#---------------------------------------------------
l_contact= Label(Inside_Frame1,text="Contact Number")
...
#<><><><><><><><><><><><><><<><<<><><<<><><><><><><><><><>
Add_button = Button(Frame2,text="Add Detail",width=15,bg="green",fg="#FFFFFF",command=AddDetail)
...
select = Listbox(DisplayFrame, yscrollcommand=scroll.set,font=("Arial Bold",10),bg="purple",fg="#E7C855",width=40,height=10,borderwidth=3,relief="groove")
